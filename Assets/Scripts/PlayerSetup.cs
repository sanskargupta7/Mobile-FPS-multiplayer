...
public class PlayerSetup : MonoBehaviourPunCallbacks
{
    ...
    private PlayerMovementController playerMovementController;    //now with this we can access player movement controller script very easily
    ...
    void Start()
    {
        ...
        if(photonView.IsMine)    //if the photon view is my perspective
        {
        ...
        else
        {
            ...
            GetComponent<RigidbodyFirstPersonController>().enabled = false;       //if it is not local player then FPS camera is disabled
